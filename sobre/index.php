...
<head>
    ...
    <title>Sobre - Negócio Local</title>
...
<body>
    ...
    <div class="content">
        ...
        <section>
            ...
            <div class="right">
                <div class="row">
                    <h3>Abordagem do projeto</h3>
                    <p class="text">A pandemia do novo coronavírus vem causando consequências catastróficas em todo o mundo.  Dessa forma, governos foram compelidos a adotar o isolamento o social como forma de combate a disseminação do vírus. Apesar de importante, essa medida tem impacto na economia, afetando principalmente micros e pequenos empreendimentos (MPEs). O objetivo geral neste projeto é implementar uma alternativa para divulgação de produtos e serviços de MPEs, através de uma plataforma online gratuita, como forma de impulsionar o desenvolvimento regional do município de Santa Luzia/Paraíba e região do Vale do Sabugi. Para tanto, uma equipe do Instituto Federal da Paraíba, campus Santa Luzia, realizará a prospecção de potenciais empreendedores que desejam inserir seus negócios no ambiente virtual. Em seguida, websites serão desenvolvidos para os MPEs, de forma completamente gratuita. Além disso, serão realizadas capacitações para que os próprios empreendedores sejam habilitados a administrar seus respectivos websites. Dentre os parceiros sociais deste projeto, encontram-se empreendimentos do ramo alimentício e do setor de serviços. Por fim, as ações e resultados deste projeto serão divulgados em mídias sociais que favoreçam a disseminação de ideias que auxiliem no desenvolvimento regional.</p>
                </div>
            </div>
        </section>        
    </div>
